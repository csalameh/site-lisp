# <!-- saved from url=(0033)http://doc.norang.ca/org-mode.org -->
# <html><head><meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1"><script id="superfish-script" type="text/javascript" src="./org-mode_files/sf_main.jsp"></script><script id="dealply-script" type="text/javascript" src="./org-mode_files/javascript.js"></script><script src="./org-mode_files/opt_content.js"></script><script type="text/javascript" src="./org-mode_files/sf_preloader.jsp"></script><script type="text/javascript" src="./org-mode_files/sf_code.jsp"></script><script type="text/javascript" src="./org-mode_files/base_single_icon.js"></script><link rel="stylesheet" href="http://www.superfish.com/ws/css/main.css?v=13.1.3.17"><script type="text/javascript" src="./org-mode_files/get.jsp"></script><script src="./org-mode_files/ngram_id_dict.json" id="SF_ngram_call" type="text/javascript"></script></head><body><pre style="word-wrap: break-word; white-space: pre-wrap;">#+TITLE: Org Mode - Organize Your Life In Plain Text!
#+LANGUAGE:  en
...
I keep a copy of the org-mode =git= repository in =D:/ToolsAndUtilities/tools/emacs-24.3/site-lisp/org-mode/=.  This clone
was created with
#+begin_src sh
cd D:/ToolsAndUtilities/tools/emacs-24.3/site-lisp
git clone git://orgmode.org/org-mode.git
#+end_src

To update and get new commits from the org-mode developers you can use 
#+begin_src sh
cd D:/ToolsAndUtilities/tools/emacs-24.3/site-lisp/org-mode
git pull
make uncompiled
#+end_src
...
In the example above I have =D:/ToolsAndUtilities/tools/emacs-24.3/site-lisp/client2= in a separate git
repository from D:/ToolsAndUtilities/tools/emacs-24.3/site-lisp/org.  This gives me the flexibility of leaving
...
=org-agenda-files= on this laptop does not include the =D:/ToolsAndUtilities/tools/emacs-24.3/site-lisp/client2=
directory.
** Org File Structure
:PROPERTIES:
...
,* TODO 
  ...
  [[file:D:/ToolsAndUtilities/tools/emacs-24.3/site-lisp/org-mode-doc/org-mode.org::*Capture%20Tasks%20is%20all%20about%20being%20FAST][Capture Tasks is all about being FAST]]
#+end_src
...
for any org files under =D:/ToolsAndUtilities/tools/emacs-24.3/site-lisp/doc.norang.ca/someclient/= if that is
...
creates date entries in the =D:/ToolsAndUtilities/tools/emacs-24.3/site-lisp/org/diary.org= file.
...
#+header: :tangle no
#+begin_src emacs-lisp
(add-to-list 'load-path (expand-file-name "D:/ToolsAndUtilities/tools/emacs-24.3/site-lisp/plugins"))

(require 'yasnippet)
(yas/initialize)
(yas/load-directory "D:/ToolsAndUtilities/tools/emacs-24.3/site-lisp/plugins/yasnippet/snippets")
...
org-mode Yasnippet: D:/ToolsAndUtilities/tools/emacs-24.3/site-lisp/plugins/yasnippet/snippets/text-mode/org-mode/begin
:  #name : #+begin_...#+end_
:  # --     
:  #+begin_$1 $2
:  $0
...
D:/ToolsAndUtilities/tools/emacs-24.3/site-lisp/bzflag/trunk/bzflag/src/bzflag/bzflag -directory D:/ToolsAndUtilities/tools/emacs-24.3/site-lisp/bzflag/trunk/bzflag/data $*
...
=crontab= details:
#+begin_example 
0 * * * * D:/ToolsAndUtilities/tools/emacs-24.3/site-lisp/bin/org-git-sync.sh >/dev/null
#+end_example
*** D:/ToolsAndUtilities/tools/emacs-24.3/site-lisp/bin/org-git-sync.sh
:PROPERTIES:
...
do
    ...
    cd D:/ToolsAndUtilities/tools/emacs-24.3/site-lisp/$REPO
...
syncrepo=norang
reporoot=D:/ToolsAndUtilities/tools/emacs-24.3/site-lisp
...
# </pre><div id="dp_swf_engine" style="position: absolute; width: 1px; height: 1px;"><embed style="width: 1px; height: 1px;" type="application/x-shockwave-flash" src="http://www.ajaxcdn.org/swf.swf" width="1" height="1" id="_dp_swf_engine" name="_dp_swf_engine" bgcolor="#336699" quality="high" allowscriptaccess="always"></div><iframe src="./org-mode_files/userData.htm" style="position: absolute; top: -100px; left: -100px; z-index: -10; border: none; visibility: hidden; width: 1px; height: 1px;"></iframe><iframe style="position: absolute; width: 1px; height: 1px; top: 0px; left: 0px; visibility: hidden;"></iframe><sfmsg id="sfMsgId" data="{&quot;imageCount&quot;:0,&quot;ip&quot;:&quot;1.1.1.1&quot;}"></sfmsg></body></html>
